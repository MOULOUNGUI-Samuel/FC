...
<main class="adminuiux-content has-sidebar" onclick="contentClick()">
      ...
      <div class="col-1">
        <div class="text-left">
          <button class="btn btn-theme"
                  wire:click="$dispatch('open-create-offcanvas', { type: 'Client' })"
                  data-bs-toggle="offcanvas" href="#particulier" role="button" aria-controls="particulier">
  ...
  {{-- Offcanvas de création (déjà prêt) --}}
  <livewire:clients.offcanvas-create />
</main>
@endsection
