<!-- Offcanvas pour la création/édition de Particuliers (Client) -->
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasParticulier" aria-labelledby="offcanvasParticulierLabel" wire:ignore.self>
  <div class="offcanvas-header">
      <p class="h5 offcanvas-title" id="offcanvasParticulierLabel">
          {{ $editingId ? 'Modifier un client particulier' : 'Nouveau client particulier' }}
      </p>
...
<script>
    document.addEventListener('livewire:initialized', () => {
        Livewire.on('ui:show-offcanvas', (event) => {
            const offcanvasId = event.id || 'offcanvasParticulier'; // Utilisez l'ID de l'offcanvas
