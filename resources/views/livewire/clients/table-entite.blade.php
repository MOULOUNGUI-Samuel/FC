    ...
    <div class="row mb-3 mt-3">
        ...
        <div class="col-2">
            <div class="text-right">
                <button class="btn btn-theme" wire:click="$dispatch('open-create-offcanvas-entite')" {{-- Simplifié --}}
                ...
                <tbody>
                    @forelse($clients as $c)
                        <tr wire:key="row-{{ $c->id }}">
                            ...
                            <td>
                                <p class="mb-0">{{ $c->numero_telephone ?? '—' }}</p>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button class="btn btn-sm btn-outline-success"
                                        wire:click="$dispatch('open-edit-offcanvas-entite', { id: '{{ $c->id }}' })">
                                        Modifier
                                    </button>
